...
@NoArgsConstructor
public class UniversidadServerError extends Exception
{
	/**
	 * Auto-generated ID
	 */
	...
	public UniversidadServerError(int id, String message, Exception exception)
	{
		super();
		this.id = id;
	...
	public UniversidadServerError(int id, String message)
	{
		super();
		this.id = id;
		this.message = message;
